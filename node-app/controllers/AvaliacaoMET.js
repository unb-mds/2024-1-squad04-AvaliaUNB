export const getAvaliacoesProfessorUsuario = (app, sequelize) => {
  app.get("/avaliacoes_professor/:matricula", async (req, res) => {
    ...
    try {
      ...
      res.status(500).json({
        success: false,
        message: "Erro ao consultar avaliações de professores",
      });
    }
  });
};
...
export const getAvaliacoesMateriaUsuario = (app, sequelize) => {
  app.get("/avaliacoes_materia/:matricula", async (req, res) => {
    ...
    try {
      ...
      res.status(500).json({
        success: false,
        message: "Erro ao consultar avaliações de matérias",
      });
    }
  });
};
...
export const deleteAvaliacaoComentarioProfessor = (app, sequelize) => {
  app.delete(
    "/avaliacoes_professor/:matricula/:cod_avaliacao/:cod_comentario",
    async (req, res) => {
      ...
      try {
        ...
        res.json({
          success: true,
          message: "Avaliação e comentário deletados com sucesso",
        });
      } catch (error) {
        console.error("Erro ao deletar avaliação e comentário:", error);
        res.status(500).json({
          success: false,
          message: "Erro ao deletar avaliação e comentário",
        });
      }
    }
  );
...
export const deleteAvaliacaoComentarioMateria = (app, sequelize) => {
  app.delete(
    "/avaliacoes_materia/:matricula/:cod_avaliacao/:cod_comentario",
    async (req, res) => {
      const { matricula, cod_avaliacao, cod_comentario } = req.params;
...
export const getProfessoresAvaliar = (app, sequelize) => {
  app.post("/avaliacao_professor", async (req, res) => {
    ...
    const nota_total =
      (nota_acesso + nota_carisma + nota_didatica + nota_metodologia) / 4;
    ...
    try {
      ...
      console.log(
        "Avaliação do professor, comentário e ligação enviados com sucesso"
      );
      res.json({
        success: true,
        message:
      ...
      console.error(
        "Erro ao enviar avaliação do professor, comentário e ligação:",
        error
      );
      res.status(500).json({
        success: false,
        message: "Erro ao enviar avaliação do professor, comentário e ligação",
      });
    }
  });
};
...
export const getMateriasAvaliar = (app, sequelize) => {
  app.post("/avaliacao_materia", async (req, res) => {
    ...
    try {
      ...
      console.log(
        "Avaliação da matéria, comentário e ligação enviados com sucesso"
      );
      res.json({
        success: true,
        message:
      ...
      console.error(
        "Erro ao enviar avaliação da matéria, comentário e ligação:",
        error
      );
      res.status(500).json({
        success: false,
        message: "Erro ao enviar avaliação da matéria, comentário e ligação",
      });
    }
  });
};
