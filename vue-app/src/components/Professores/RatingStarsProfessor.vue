  ...
  <div class="container">
    <div class="notas">
      ...
      <div class="rating">
        <input
          ...
          id="star1-5"
          value="10"
          @change="emitirAvaliacao"
          v-model="rating.notaAcesso"
          style="--c: #0a745b"
        />
        <input
          type="radio"
    ...
    <div class="notas">
      ...
      <div class="rating">
        <input
          type="radio"
          name="notaMetodologia"
          id="star3-5"
          value="10"
          @change="emitirAvaliacao"
          v-model="rating.notaMetodologia"
          style="--c: #0a745b"
        />
        <input
          type="radio"
